...
# Explain.
# I decided to use the data type string for the first because it is a collection of character, the 2nd I used a boolean because it is true or false, and the 3rd i used integer because it is a number
